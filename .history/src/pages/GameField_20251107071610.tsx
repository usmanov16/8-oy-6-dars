...
function GameField() {
    ...
    return (
      <div className="py-10">
        ...
        <div className="mb-15 flex-wrap flex gap-x-5  items-center justify-center">
          {data &&
            data.questions[activeQuestion].word
              ...
              .map((word, i) => {
                return (
                    <div key={i}>{word.split("").map(letter, i) => {
                        return <span className="border border-gray-400 py-4 px-4" key={i}>
                            {letter}
                        </span>
                    }}
